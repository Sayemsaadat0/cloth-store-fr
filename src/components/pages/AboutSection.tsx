  ...
  const values = [
    {
      ...
      linear: "from-amber-400/20 to-yellow-600/20"
    },
    {
      icon: Heart,
      title: "Passion",
      description: "Driven by love for the art of fashion",
      linear: "from-rose-400/20 to-pink-600/20"
    },
    {
      icon: Sparkles,
      title: "Innovation",
      description: "Pushing boundaries while honoring tradition",
      linear: "from-blue-400/20 to-cyan-600/20"
    },
    {
      icon: Users,
      title: "Community",
      description: "Building lasting relationships with our clients",
      linear: "from-purple-400/20 to-indigo-600/20"
    }
  ];
  ...
  return (
    <section id="about" className="relative  py-24 ">
      <div className="mx-auto max-w-7xl">
        {/* Main About Box */}
        <div className="group relative overflow-hidden rounded-3xl border border-white/30 bg-linear-to-br from-white/10 via-white/5 to-white/10 p-8 backdrop-blur-2xl transition-all hover:border-white/40 sm:p-12 lg:p-16">
          {/* Decorative linear overlay */}
          <div className="absolute -right-20 -top-20 h-64 w-64 rounded-full bg-linear-to-br from-white/10 to-transparent blur-3xl transition-all group-hover:scale-110"></div>
          <div className="absolute -bottom-20 -left-20 h-64 w-64 rounded-full bg-linear-to-tr from-white/10 to-transparent blur-3xl transition-all group-hover:scale-110"></div>
          ...
          <div className="relative">
            ...
            <div className="mb-20">
              <div className="mx-auto max-w-3xl space-y-6 text-center">
                ...
                <div className="mx-auto flex items-center justify-center gap-2">
                  <div className="h-px w-8 bg-linear-to-r from-transparent to-white/40"></div>
                  <div className="h-1 w-1 rotate-45 bg-white/60"></div>
                  <div className="h-px w-8 bg-linear-to-l from-transparent to-white/40"></div>
                </div>
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
              {values.map((value, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="group/card relative overflow-hidden rounded-2xl border border-white/20 bg-linear-to-br from-white/10 to-white/5 p-8 text-center backdrop-blur-xl transition-all hover:scale-105 hover:border-white/40 hover:shadow-2xl hover:shadow-white/10"
                  >
                    {/* Card linear overlay */}
                    <div className={`absolute inset-0 bg-linear-to-br ${value.linear} opacity-0 transition-opacity group-hover/card:opacity-100`}></div>
                    
                    <div className="relative">
                      <div className="mb-6 flex justify-center">
                        <div className="relative">
                          <div className="absolute inset-0 rounded-2xl bg-white/20 blur-xl transition-all group-hover/card:bg-white/30"></div>
                          <div className="relative rounded-2xl border border-white/30 bg-linear-to-br from-white/20 to-white/10 p-4 backdrop-blur-xl transition-all group-hover/card:border-white/50 group-hover/card:from-white/30 group-hover/card:to-white/20">
            ...
            <div className="mt-20 text-center">
              <div className="mx-auto mb-8 flex items-center justify-center gap-3">
                <div className="h-px w-16 bg-linear-to-r from-transparent to-white/40"></div>
                <div className="h-1.5 w-1.5 rotate-45 bg-white/60"></div>
                <div className="h-px w-16 bg-linear-to-l from-transparent to-white/40"></div>
              </div>
              <div className="relative mx-auto max-w-3xl rounded-2xl border border-white/20 bg-linear-to-br from-white/10 to-white/5 p-8 backdrop-blur-xl sm:p-10">
