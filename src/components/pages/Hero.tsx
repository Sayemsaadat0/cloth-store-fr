  ...
  return (
    <section className="relative flex min-h-screen w-full items-center justify-center mt-16">
      ...
      <div className="relative z-10 mx-auto max-w-7xl w-full p-4 sm:p-6 lg:p-8 text-center">
        ...
        {/* Main Heading */}
        <h1
          className="mb-8 animate-fade-in-up text-5xl text-white drop-shadow-2xl sm:text-6xl lg:text-8xl"
        ...
        {/* Subheading */}
        <p
          className="mx-auto mb-12 max-w-2xl animate-fade-in-up text-lg leading-relaxed text-white/95 drop-shadow-lg sm:text-xl"
          style={{ animationDelay: "0.3s" }}
        >
          Discover our curated collection of haute couture pieces that define
          modern luxury. Each garment is a masterpiece of design, crafted for
          those who appreciate timeless style.
        </p>
        ...
        {/* Enhanced Stats */}
        <div
          className="mx-auto grid max-w-4xl grid-cols-3 gap-8 animate-fade-in-up"
        ...
        >
          <div className="group relative overflow-hidden rounded-none border-r border-white/20 px-4 transition-all hover:scale-105">
            ...
            <div className="relative">
              <div className="bg-linear-to-br from-white to-white/70 bg-clip-text text-4xl text-transparent drop-shadow-lg lg:text-5xl">
                500+
              </div>
